...
class Datasets(jaml.YAMLWrapper):
    ...
    def plot_timeline(
        ...
        plot_datasets_timeline(
            ...
            subbar_groupby=subbar_groupby,
            share_y=share_y,
            legend=legend,
            annotate_bars=annotate_bars,
            annotate_total_number=annotate_total_number,
            cumulated=cumulated,
            kwargs_subbar=kwargs_subbar,
            kwargs_bar_cum=kwargs_bar_cum,
            kwargs_subplots=kwargs_subplots,
            kwargs_annotation_bars=kwargs_annotation_bars,
            kwargs_annotation_total_number=kwargs_annotation_total_number,
